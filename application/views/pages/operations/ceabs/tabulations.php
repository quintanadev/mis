            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="text-right">
                        <h3 class="mt-1"><span id="counterup-agendamento">-</span>%</h3>
                        <p class="text-muted mb-1 text-truncate">Agendamento</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4 col-xl-4">
        <div class="widget-rounded-circle card-box">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="text-right">
                        <h3 class="mt-1"><span id="counterup-sucesso">-</span>%</h3>
                        <p class="text-muted mb-1 text-truncate">Sucesso</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="radio radio-info form-check-inline">
                                <input type="radio" id="radioPercentual" value="percentual" name="radioVisao" checked>
                                <label for="radioPercentual"> Percentual </label>
                            </div>
                            <div class="radio radio-info form-check-inline">
                                <input type="radio" id="radioValor" value="valor" name="radioVisao">
                                <label for="radioValor"> Valor Absoluto </label>
                            </div>
                            </div>
                        </div>
                    </div>
